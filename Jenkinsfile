            ...
            stages{
                ...
                stage('Test') {
                    steps {
                        ...
                        //sh 'podman run -it --rm localhost/$IMAGE_NAME R -e "library(\"tidyverse\");library(\"mosaic\");library(\"mosaicCore\");library(\"MosaicData\");library(\"openintro\");library(\"palmerpenguins\");library(\"olilabs\");library(\"RColorBrewer\");library(\"knitr\");library(\"markdown\");library(\"rmarkdown\");library(\"car\");library(\"carData\");library(\"cherryblossom\");library(\"datasets\");library(\"DBI\");library(\"dbplyr\");library(\"network\");library(\"DT\");library(\"emo\");library(\"fivethirtyeight\");library(\"gargle\");library(\"Lock5Data\");library(\"MASS\")"'
